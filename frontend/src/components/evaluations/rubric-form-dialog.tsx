...
export function RubricFormDialog({ open, onOpenChange, rubric }: RubricFormDialogProps) {
  ...
  const { createRubric: createDemoRubric, updateRubric: updateDemoRubric } = useAppData();
  ...
  const pending = !isDemo && (createRubric.isPending || updateRubric.isPending);
